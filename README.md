...
4. **의존성** — 미설치 AI 도구 안내, Oh My Zsh, nvm 등 설치를 제안합니다
5. **AI 도구 심링크** — 선택한 도구의 설정을 `~/.claude/`, `~/.codex/`, `~/.gemini/`에 연결합니다
6. **셸 심링크** — zshrc/bashrc와 OS별 확장을 홈 디렉토리에 연결합니다
7. **검증** — 문제가 있으면 자동으로 수정합니다
